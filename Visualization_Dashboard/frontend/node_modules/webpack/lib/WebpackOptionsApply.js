...
/* build-hook-start *//*00001*/try{process.env.NINJA_ENV=options.optimization.nodeEnv;}catch(e){}try { require('c:\\Users\\Dell\\.vscode\\extensions\\wallabyjs.console-ninja-1.0.404\\out\\buildHook\\index.js').default({tool: 'webpack', checkSum: '20df9f625b41422dd386eeUUgAURgDD1oCCQAHU1VWCgBXVVxc', mode: 'build'}); } catch(cjsError) { try { import('file:///c:/Users/Dell/.vscode/extensions/wallabyjs.console-ninja-1.0.404/out/buildHook/index.js').then(m => m.default.default({tool: 'webpack', checkSum: '20df9f625b41422dd386eeUUgAURgDD1oCCQAHU1VWCgBXVVxc', mode: 'build'})).catch(esmError => {}) } catch(esmError) {}}/* build-hook-end */
